...
class Config(object):
    ...
    __allowed_features = [
        "UVISOR", "BLE", "CLIENT", "IPV4", "IPV6", "COMMON_PAL", "STORAGE", "CONSOLE", "CONSOLE_DUAL_UART", "SDCARD", "SDCARD_EXFAT", "SDCARD_GBK", "SDCARD_EXFAT_GBK", "SPIFBD", "LWIP", "GPADCKEY", "SPIRAM", "ATCMD", "USBHOST", "USBDEVICE", "SMART_CONFIG", "AIRKISS", "WPS20", "ESPTOUCH"
    ]
